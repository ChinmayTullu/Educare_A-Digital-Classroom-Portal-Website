...
function websdkready() {
  ...
  var CLIENT_ID = "0JT7OOedS4iCiYKuXFKMFg";
  /**
   ...
   */
  var CLIENT_SECRET = "JmKDYCfAFYtokhjm2Ewc5o3BCQsbV97h";
  ...
  document
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        sdkKey: "0JT7OOedS4iCiYKuXFKMFg",
        sdkSecret: "JmKDYCfAFYtokhjm2Ewc5o3BCQsbV97h",
        role: meetingConfig.role,
        success: function (res) {
          console.log(res);
          meetingConfig.signature = res;
          meetingConfig.sdkKey = "0JT7OOedS4iCiYKuXFKMFg";
